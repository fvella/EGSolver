...
/** \brief PRIMA PARTIZIONA RISPETTO A SOGLIA configuration.shuffleSplit_val, poi a parita di owner, compara due nodi rispetto al grado totale (indegree+outdegree), prima grado inferiore
 */
int split_prima0poi1_alldeg(const void * a,const void * b) {
	const char *pval1 = (char *)(nodeOwner+*((int *)a));
	const char *pval2 = (char *)(nodeOwner+*((int *)b));
	const int *outdeg1 = (int *)(outDegrees_of_csr+*((int *)a));
	const int *outdeg2 = (int *)(outDegrees_of_csr+*((int *)b));
	...
	const int *indeg2 = (int *)(inDegrees_of_csr+*((int *)b));
//printf(" CMP: %d %d  alldegs: %d %d\n",(*pval1) , (*pval2), ((*indeg1)+(*outdeg1)), ((*indeg2)+(*outdeg2)) );
	if ( ((*outdeg1)<=configuration.shuffleSplit_val) == ((*outdeg2)<=configuration.shuffleSplit_val) ) { //entrambi nella stessa partizione
		if ( (*pval1) == (*pval2) ) {
			if ( ((*indeg1)+(*outdeg1)) == ((*indeg2)+(*outdeg2)) ) {
				return(0);
			} else {
	...
	} else {// se non sono nella stessa partizione: ordine relativo dato dai degree
		return(((*outdeg1) < (*outdeg2)) ? -1 : 1);
	}
}

/** \brief PRIMA PARTIZIONA RISPETTO A SOGLIA configuration.shuffleSplit_val, poi a parita di owner, compara due nodi rispetto a outdegree e a parita di outdegree compara con indegree 
 */
int split_prima0poi1_outdeg_indeg(const void * a,const void * b) {
	const char *pval1 = (char *)(nodeOwner+*((int *)a));
	const char *pval2 = (char *)(nodeOwner+*((int *)b));
	const int *outdeg1 = (int *)(outDegrees_of_csr+*((int *)a));
	const int *outdeg2 = (int *)(outDegrees_of_csr+*((int *)b));
...
/** \brief PRIMA PARTIZIONA RISPETTO A SOGLIA configuration.shuffleSplit_val, poi a parita di owner, compara due nodi rispetto a outdegree
 */
int split_prima0poi1_outdeg(const void * a,const void * b) {
	const char *pval1 = (char *)(nodeOwner+*((int *)a));
	const char *pval2 = (char *)(nodeOwner+*((int *)b));
	const int *outdeg1 = (int *)(outDegrees_of_csr+*((int *)a));
	const int *outdeg2 = (int *)(outDegrees_of_csr+*((int *)b));
...
/** \brief PRIMA PARTIZIONA RISPETTO A SOGLIA configuration.shuffleSplit_val, poi a parita di owner, compara due nodi rispetto a indegree 
 */
int split_prima0poi1_indeg(const void * a,const void * b) {
	const char *pval1 = (char *)(nodeOwner+*((int *)a));
	const char *pval2 = (char *)(nodeOwner+*((int *)b));
	const int *outdeg1 = (int *)(outDegrees_of_csr+*((int *)a));
	const int *outdeg2 = (int *)(outDegrees_of_csr+*((int *)b));
...
/** \brief PRIMA PARTIZIONA RISPETTO A SOGLIA configuration.shuffleSplit_val, poi compara due nodi solo rispetto all'owner: prima owner 0 e poi 1 
 */
int split_prima0poi1(const void * a,const void * b) {
        const char *pval1 = (char *)(nodeOwner+*((int *)a));
        const char *pval2 = (char *)(nodeOwner+*((int *)b));
	const int *outdeg1 = (int *)(outDegrees_of_csr+*((int *)a));
	const int *outdeg2 = (int *)(outDegrees_of_csr+*((int *)b));
